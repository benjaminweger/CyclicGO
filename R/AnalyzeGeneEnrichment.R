...
CreateSym2Entrez <- function(){
  sym2entrez <- AnnotationDbi::as.list(org.Mm.egALIAS2EG)
  sym2entrez <- sym2entrez[!is.na(sym2entrez)]
  return(sym2entrez)
}

CreateEntrez2Sym <- function(){
  entrez2sym <- AnnotationDbi::as.list(org.Mm.egSYMBOL)
...
CreateEntrez2GO <- function(){
  ...
  entrez2GO.full <- AnnotationDbi::as.list(entrez2GO.obj[mapped.genes])
...
CreateGO2AllEntrez <- function(){
  go2entrez <- AnnotationDbi::as.list(org.Mm.egGO2ALLEGS)
  go2entrez <- go2entrez[!is.na(go2entrez)]
  return(go2entrez)
}

CreateGO2Entrez <- function(){
  go2entrez <- AnnotationDbi::as.list(org.Mm.egGO2EG)
  go2entrez <- go2entrez[!is.na(go2entrez)]
  return(go2entrez)
}
